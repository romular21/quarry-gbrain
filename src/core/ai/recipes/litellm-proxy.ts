...
export const litellmProxy: Recipe = {
  ...
  setup_hint: 'Run LiteLLM (https://docs.litellm.ai) in front of any provider; set LITELLM_BASE_URL, optionally set LITELLM_API_KEY, and use litellm:<model> for chat. For embeddings, also pass --embedding-dimensions <N>.',
};
